...
original_gt_dir="/home/i3gupta/lustre/DSC291/data/out/cissnps/baseline"
out_dir="/home/i3gupta/lustre/DSC291/data/out/cissnps/cis_epi"
out="/home/i3gupta/lustre/DSC291/data/out"

################################################################################################
# # Bin SNPs by epigenetic info
################################################################################################
...
# (
# jobfile=$jobsdir/fusion_job_${i}.sh
# echo "g=$g" > $jobfile
